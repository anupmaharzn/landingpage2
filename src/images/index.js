export const image = {
    ...
    footer_mobile: require('./bg-pattern-footer-mobile.svg').default,
    fb: require('./icon-facebook.svg').default,
    twitter: require('./icon-twitter.svg').default,
    pintrest: require('./icon-pinterest.svg').default,
    ...
    affordable_price: require("./icon-affordable-prices.svg").default,
